...
class ADMMHazardAFT:
    ...
    def __init__(
        ...
        admm_stagnation_tol: float = 1e-10,
        admm_stagnation_patience: int = 10,
    ...
    def _build_components(self, T: ArrayLike) -> _FitComponents:
        ...
        solver = FusedLassoADMMSolver(
            ...
            admm_stagnation_tol=self.admm_stagnation_tol,
            admm_stagnation_patience=self.admm_stagnation_patience,
